...
public class ThirdSelectView extends View {
    ...
    private static final String[] VALUES = new String[]{"cm", "ft in"}; //英制数据
    ...
    public ThirdSelectView(Context context) {
        this(context, null);
    }

    public ThirdSelectView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ThirdSelectView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void computeScroll() {
        ...
        if (mScroller.computeScrollOffset()) {
            ...
            if (index != mSelectIndex && mValueSelectListener != null && mAutoSmoothScrollable) {
                mSelectIndex = index;
                mValueSelectListener.onThirdValueSelectedListener(mSelectIndex, VALUES[mSelectIndex]);
            }
    ...
    private void init() {
        ...
        Rect rect = new Rect();
        String text = String.valueOf(MIN_INDEX);
    ...
    public interface ValueSelectListener {
         ...
         * @param value 值
         */
        void onThirdValueSelectedListener(int index, String value);
    }
